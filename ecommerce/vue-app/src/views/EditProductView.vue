    ...
    <div class="border mt-2 p-6 rounded-md w-full md:w-2/3 lg:w-1/2 xl:w-1/3">
      ...
      <div v-if="!submitted">
        <form>
          ...
          <div class="mb-6">
            <button type="button" @click="updateProduct" class="w-full cursor-pointer bg-blue-500 text-white p-2 rounded-md hover:bg-blue-600">
              Update
            </button>
            <button type="button" @click="deleteProduct" class="mt-5 cursor-pointer w-full bg-red-500 text-white p-2 rounded-md hover:bg-red-600">
                Delete
            </button>
          </div>
        </form>
